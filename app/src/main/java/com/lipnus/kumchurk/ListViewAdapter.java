    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        category_FL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isOpen){//닫기
                    ...
                    scActivity.closeMenuList(listViewItem.getCategory_name(), pos);
                }else{//열기
                    Glide.with(context)
                    ...
                    scActivity.openMenuList(listViewItem.getCategory_name(), pos);
                    //얘 때문에 화면이 새로 그려짐.
        ...
        left_menu_fL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ListViewItem listViewItem = listViewItemList.get(pos);
                Log.d("CLCL", "메뉴이름: " + listViewItem.getLeft_menu_name() );
                Log.d("CLCL", "식당: " +  listViewItem.getRes_key() + " 메뉴: "+ listViewItem.getLeft_menuKey() );

                Intent iT = new Intent(context, ScrollActivity.class); // 다음넘어갈 화면
                iT.putExtra("res_key", listViewItem.getRes_key());
                iT.putExtra("menu_key", listViewItem.getLeft_menuKey());
        ...
        right_menu_fL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent iT = new Intent(context, ScrollActivity.class); // 다음넘어갈 화면
                iT.putExtra("res_key", listViewItem.getRes_key());
                iT.putExtra("menu_key", listViewItem.getRight_menuKey());
                iT.putExtra("review_key", "");
                context.startActivity(iT);
