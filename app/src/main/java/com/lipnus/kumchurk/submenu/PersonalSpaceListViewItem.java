...
public class PersonalSpaceListViewItem {

    public PersonalSpaceListViewItem(ResInfo_fb resInfo_fb, MenuInfo_fb menuInfo_fb, MenuReview_fb menuReview_fb, User_fb user_fb) {
