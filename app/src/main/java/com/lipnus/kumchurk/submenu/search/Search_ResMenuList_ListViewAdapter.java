 ...
 */
public class Search_ResMenuList_ListViewAdapter extends BaseAdapter {

    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<Search_ResMenuList_ListViewItem> listViewItemList = new ArrayList<Search_ResMenuList_ListViewItem>() ;

    // ListViewAdapter의 생성자
    public Search_ResMenuList_ListViewAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Search_ResMenuList_ListViewItem sRML = listViewItemList.get(position);
        ...
        category_FL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Search_ResMenuList_Activity srmlActivity = (Search_ResMenuList_Activity) Search_ResMenuList_Activity.SRMLActivity;
                Search_ResMenuList_ListViewItem listViewItem = listViewItemList.get(pos);
                ...
                if(isOpen){//닫기
                    ...
                    srmlActivity.closeMenuList(listViewItem.getCategory_name(), pos);
                }else{//열기
                    Glide.with(context)
                    ...
                    srmlActivity.openMenuList(listViewItem.getCategory_name(), pos);
                    //얘 때문에 화면이 새로 그려짐.
        ...
        left_menu_fL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Search_ResMenuList_Activity srmlActivity = (Search_ResMenuList_Activity) Search_ResMenuList_Activity.SRMLActivity;
                Search_ResMenuList_ListViewItem sRML = listViewItemList.get(pos);

                Intent iT = new Intent(context, ScrollActivity.class); // 다음넘어갈 화면
                iT.putExtra("res_key", sRML.getRes_key());
                iT.putExtra("menu_key", sRML.getLeft_menuKey());
                iT.putExtra("review_key", "");
        ...
        right_menu_fL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent iT = new Intent(context, ScrollActivity.class); // 다음넘어갈 화면
                iT.putExtra("res_key", sRML.getRes_key());
                iT.putExtra("menu_key", sRML.getRight_menuKey());
                iT.putExtra("review_key", "");
                context.startActivity(iT);
        ...
        //좌측부분
        if( sRML.isLeft_menu_visible() ){ left_menu_fL.setVisibility(View.VISIBLE); }
        else{ left_menu_fL.setVisibility(View.GONE); }
        left_menu_name_Tv.setText( sRML.getLeft_menu_name() );
        left_menu_cost_Tv.setText( sRML.getLeft_menu_cost() );
        Glide.with(context)
                .load( sRML.getLeft_menu_image() )
        ...
        //우측부분
        if( sRML.isRight_menu_visible() ){ right_menu_fL.setVisibility(View.VISIBLE); }
        else{ right_menu_fL.setVisibility(View.GONE); }
        right_menu_name_Tv.setText( sRML.getRight_menu_name() );
        right_menu_cost_Tv.setText( sRML.getRight_menu_cost() );
        Glide.with(context)
                .load( sRML.getRight_menu_image() )
                .placeholder(R.drawable.loading)
                .centerCrop()
                .into(right_menu_Iv);
        ...
        if( sRML.isCategory_visible() ){
            ...
            Log.d("JJJJ", "리셋되나: " + sRML.isCategoryOpen() );

        }
        else{ category_FL.setVisibility(View.GONE); }
        category_Tv.setText( sRML.getCategory_name() );
    ...
    public void addItem(boolean lvisible, String lname, String lcost, String lPic, String lMenuKey,
                        ...
                        String res_name, String res_key) {

        Search_ResMenuList_ListViewItem item = new Search_ResMenuList_ListViewItem();
    ...
    public void addItem(boolean lvisible, String lname, String lcost, String lPic, String lMenuLey,
                              boolean rvisible, String rname, String rcost, String rPic, String rMenukey,
                              boolean category_visible, String category_name,
                              String res_name, String res_key, int index){
