...
import com.lipnus.kumchurk.detailpage.ReviewSelectActivity;
 ...
 */
public class ReviewSearch_Res_ListViewAdapter extends BaseAdapter {

    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<ReviewSearch_Res_ListViewItem> listViewItemList = new ArrayList<>() ;


    // ListViewAdapter의 생성자
    public ReviewSearch_Res_ListViewAdapter() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ReviewSearch_Res_ListViewItem listViewItem = listViewItemList.get(position);
        ...
        foodIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent iT = new Intent(context, ReviewSelectActivity.class); // 다음넘어갈 화면
    ...
    public void addItem(ResInfo_fb resInfo_fb) {
        ...
        ReviewSearch_Res_ListViewItem item = new ReviewSearch_Res_ListViewItem(resInfo_fb);
